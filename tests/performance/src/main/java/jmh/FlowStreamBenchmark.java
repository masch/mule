...
public class FlowStreamBenchmark {
  ...
  @Param({
      ...
      "org.mule.runtime.core.processor.strategy.MultiReactorProcessingCPUStrategyFactory",
      "org.mule.runtime.core.processor.strategy.MultiReactorProcessingCPUOver2StrategyFactory"})
  ...
  @Benchmark
  @Threads(1)
  public void pushSource1Thread(Blackhole blackhole) throws MuleException {
  ...
  @Benchmark
  @Threads(16)
  public void pushSource16Threads(Blackhole blackhole) throws MuleException {
    Event event = Event.builder(DefaultEventContext.create(flow, TEST_CONNECTOR))
        .message(InternalMessage.of(TEST_PAYLOAD)).build();
    source.accept(event);
    Mono.from(event.getContext()).doOnNext(e -> blackhole.consume(e)).subscribe();
